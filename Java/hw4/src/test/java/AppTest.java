...
public class AppTest {
    ...
    public void testGetVector() throws Exception {
        String s = "(1,2,3)";
        assertArrayEquals(new int[] {1, 2, 3}, App.getVector(s));
    }
    @Test
    public void testGetVectorException() throws Exception{
        String s = "(1,2"; 
        try {
            App.getVector(s);
            ...
            assertEquals((new Exception("Format Error")).toString(), e.toString());
        }
    }
}
